-- ////// START : GENERATED FROM C:\Users\dack_janiels\Documents\LUIE\LuiExtended\LuiExtended\frontend\ChangelogTemplates.xml
---------- LVL: 00 ----------
---------- LVL: 01 ----------
---------- LVL: 02 ----------
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_Changelog_SectionHeader_Template : Control
---@field public mouseEnabled boolean
---@field public hidden boolean
---@field Dimensions {x: layout_measurement, y: layout_measurement}
LUIE_Changelog_SectionHeader_Template = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
...
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_Changelog_SectionHeader_TemplateTitle : LabelControl
...
LUIE_Changelog_SectionHeader_TemplateTitle = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_Changelog_SectionHeader_TemplateToggle : ButtonControl
---@field public font string
---@field public text string
---@field public mouseEnabled boolean
---@field Dimensions {x: layout_measurement, y: layout_measurement}
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition, offsetX: layout_measurement, offsetY: layout_measurement}
LUIE_Changelog_SectionHeader_TemplateToggle = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
...
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_Changelog_SectionBody_TemplateText : LabelControl
---@field public font string
---@field public wrapMode TextWrapMode
---@field public horizontalAlignment TextAlignment
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition, offsetX: layout_measurement, offsetY: layout_measurement}
...
---------- LVL: 05 ----------
-- ////// END   : GENERATED FROM C:\Users\dack_janiels\Documents\LUIE\LuiExtended\LuiExtended\frontend\ChangelogTemplates.xml
