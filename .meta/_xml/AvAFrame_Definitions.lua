-- ////// START : GENERATED FROM C:/Users/dack_janiels/Desktop/LUIE_WORKSPACE/LuiExtended/LuiExtended\frontend\UnitFrames\AvAFrame.xml
---------- LVL: 00 ----------
---------- LVL: 01 ----------
---------- LVL: 02 ----------
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_OverlandDifficultyIcon : TextureControl
---@field public textureFile string
---@field public hidden boolean
---@field Dimensions {x: layout_measurement, y: layout_measurement}
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition, offsetX: layout_measurement}
LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_OverlandDifficultyIcon = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_LevelIcon : TextureControl
---@field public textureFile string
---@field public hidden boolean
---@field Dimensions {x: layout_measurement, y: layout_measurement}
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition}
LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_LevelIcon = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_VeterancyRankIcon : TextureControl
---@field public textureFile string
---@field public hidden boolean
---@field Dimensions {x: layout_measurement, y: layout_measurement}
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition}
LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_VeterancyRankIcon = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
---@class LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_Level : LabelControl
---@field public text string
---@field public font string
---@field public color string
---@field public horizontalAlignment TextAlignment
...
---@field public hidden boolean
---@field Anchor {point: AnchorPosition, relativeTo: string, relativePoint: AnchorPosition, offsetX: layout_measurement}
LUIE_UF_AvaPlayerTargetFrame_Template_Target_TopInfo_Level = {}
-- ---------------------------------------------------------------------------------------------------------------------
--
...
---------- LVL: 11 ----------
-- ////// END   : GENERATED FROM C:/Users/dack_janiels/Desktop/LUIE_WORKSPACE/LuiExtended/LuiExtended\frontend\UnitFrames\AvAFrame.xml
