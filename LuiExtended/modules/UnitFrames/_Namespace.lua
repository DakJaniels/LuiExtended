...
UnitFrames.Defaults =
{
    ...
    SuppressZOPlayerAttributeBarsWhenReplaced = false,
    SuppressZOTargetFrameWhenReplaced = false,
    SuppressZOGroupFramesWhenReplaced = false,
    SuppressZOCompanionFrameWhenReplaced = false,
