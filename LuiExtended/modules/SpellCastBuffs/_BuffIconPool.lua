...
local function SetupBuffIconControlReferences(buff)
    ...
    buff.abilityId:SetFont(SpellCastBuffs.buffsFont or "LUIE Default Font")
    buff.abilityId:SetWrapMode(TEXT_WRAP_MODE_TRUNCATE)
    buff.stack:SetFont(SpellCastBuffs.buffsFont or "LUIE Default Font")
    ...
    buff.name:SetFont(SpellCastBuffs.prominentFont or "LUIE Default Font")
