...
local strings =
{
    ...
    LUIE_STRING_LAM_MINIMAP_MOVING_PIN_REFRESH_MS_TP = "Gruppe und Begleiter sowie HUD-Spieler-Pip-Sync (native + Overlay-Pfeile) bei „Spieler folgen“. Niedriger = flüssiger, höher = weniger CPU.",
    ...
    LUIE_STRING_LAM_MINIMAP_CAMERA_WEDGE_TP = "Größe der Overlay-Kamera-Keiltextur bei Spieler folgen ohne native Weltkarte. Mit nativer Karte: beide Pfeile nutzen Spieler-Pip-Skalierung; Kamera-Keil-Farbe für den Kamera-Pfeil.",
