...
local strings =
{
    ...
    LUIE_STRING_LAM_MINIMAP_CAMERA_WEDGE_TP = "Размер оверлей-клина камеры при следовании без нативной карты. С нативной картой оба указателя — по масштабу пипа игрока; цвет клина камеры для стрелки камеры.",
