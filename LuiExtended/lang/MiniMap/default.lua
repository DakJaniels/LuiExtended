...
local strings =
{
    ...
    LUIE_STRING_LAM_MINIMAP_WAYPOINT_SHIFT_TP = "When enabled, Shift+left-click sets a player waypoint and Shift+right-click clears it. When disabled, a plain click on the map sets a waypoint if you did not drag.",
    ...
    LUIE_STRING_LAM_MINIMAP_SUBZONE_ZOOM_TP = "Base zoom level on overworld maps that use multiple tiles.",
    LUIE_STRING_LAM_MINIMAP_DUNGEON_ZOOM = "Dungeon Zoom (%)",
    LUIE_STRING_LAM_MINIMAP_DUNGEON_ZOOM_TP = "Base zoom level in dungeon map contexts.",
    LUIE_STRING_LAM_MINIMAP_BATTLEGROUND_ZOOM = "Battleground Zoom (%)",
    LUIE_STRING_LAM_MINIMAP_BATTLEGROUND_ZOOM_TP = "Base zoom level in battleground map contexts.",
    LUIE_STRING_LAM_MINIMAP_MOUNTED_ZOOM = "Mounted Zoom Multiplier (%)",
    LUIE_STRING_LAM_MINIMAP_MOUNTED_ZOOM_TP = "Multiplies the context base zoom while you are mounted (100% = no change).",
