...
local strings =
{
    ...
    LUIE_STRING_LAM_MINIMAP_CAMERA_WEDGE_TP = "Taille du cône caméra overlay si Suivre le joueur sans carte native. Avec carte native : les deux flèches utilisent l’échelle Pip joueur ; couleur Cône caméra pour la flèche caméra.",
