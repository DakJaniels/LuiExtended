...
function UnitFrames.CreateConsoleSettings()
    ...
    buildSectionSettings("DefaultFrames", function (settings)
        ...
        settings[#settings + 1] =
        {
            ...
            label = GetString(LUIE_STRING_LAM_UF_SUPPRESS_ZO_PLAYER),
        ...
        {
            type = LHAS.ST_CHECKBOX,
            label = GetString(LUIE_STRING_LAM_UF_SUPPRESS_ZO_TARGET),
        ...
        {
            type = LHAS.ST_CHECKBOX,
            label = GetString(LUIE_STRING_LAM_UF_SUPPRESS_ZO_GROUP),
        ...
        {
            type = LHAS.ST_CHECKBOX,
            label = GetString(LUIE_STRING_LAM_UF_SUPPRESS_ZO_COMPANION),
