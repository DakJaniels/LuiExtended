...
local infiniteArchiveAlerts =
{
    ...
    [221209] = { priority = 1, result = ACTION_RESULT_BEGIN, block = true, dodge = true, interrupt = true, bs = true, duration = 2000, sound = LUIE_ALERT_SOUND_TYPE_ST_CC },  -- Shock Aura
    ...
    [221364] = { priority = 1, result = ACTION_RESULT_BEGIN, block = true, dodge = true, interrupt = true, bs = true, duration = 44000, sound = LUIE_ALERT_SOUND_TYPE_ST_CC }, -- Fabled Stormcaller's cast
    ...
    [221959] = { priority = 1, result = ACTION_RESULT_BEGIN, block = true, dodge = true, interrupt = true, bs = true, duration = 1500, sound = LUIE_ALERT_SOUND_TYPE_ST_CC },  -- Air Burst (charge) -> Beam (must interrupt)
