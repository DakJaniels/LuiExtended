...
local strings =
{
    ...
    LUIE_STRING_SKILL_MUNDUS_BASIC_WARRIOR = "Повышает ваш урон от Оружия и Заклинаний на |cFFFFFF238|r.",
    LUIE_STRING_SKILL_MUNDUS_BASIC_APPRENTICE = "Повышает получение опыта и вдохновения.",
    ...
    LUIE_STRING_SKILL_MINOR_BRUTALITY_TP = "Повышает урон от оружия и заклинаний на |cFFFFFF10|r%.",
    LUIE_STRING_SKILL_MAJOR_BRUTALITY_TP = "Повышает урон от оружия и заклинаний на |cFFFFFF20|r%.",
