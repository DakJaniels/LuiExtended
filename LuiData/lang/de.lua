...
local strings =
{
    ...
    LUIE_STRING_SKILL_MUNDUS_BASIC_WARRIOR = "Erhöht Eure Waffen- und Magiekraft um |cFFFFFF238|r.",
    LUIE_STRING_SKILL_MUNDUS_BASIC_APPRENTICE = "Erhöht Erfahrungs- und Inspirationsgewinn.",
