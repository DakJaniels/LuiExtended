...
local strings =
{
    ...
    LUIE_STRING_SKILL_MUNDUS_BASIC_WARRIOR = "Augmente les dégâts des armes et des sorts de |cFFFFFF238|r.",
    LUIE_STRING_SKILL_MUNDUS_BASIC_APPRENTICE = "Augmente le gain d'expérience et d'inspiration.",
    ...
    LUIE_STRING_SKILL_MINOR_BRUTALITY_TP = "Augmente les dégâts des armes et des sorts de |cFFFFFF10|r%.",
    LUIE_STRING_SKILL_MAJOR_BRUTALITY_TP = "Augmente les dégâts des armes et des sorts de |cFFFFFF20|r%.",
